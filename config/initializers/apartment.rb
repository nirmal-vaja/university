...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = %w{ University }
  ...
  #
  config.tenant_names = lambda{ University.accepted.pluck(:subdomain) }
...
Apartment::Elevators::Subdomain.excluded_subdomains = ['www', 'e0d9-117-97-175-176', 'ac0e-2401-4900-1c80-7ed3-9dfc-61b8-86fb-52f9', '5dde-2401-4900-1c80-7ed3-61bc-b3a4-15ec-cb0e', 'ec2-3-110-181-152', 'e36f-171-78-214-116','4209-2401-4900-1f3f-bab2-7eac-b914-b268-f018', 'ec2-3-110-133-204', 'public']
